		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: WChaMax_SF, Offset: 16, Type: typelabel.Sunssf, Access: "r", Length: 1, Mandatory: true},
					smdx.PointElement{Id: WChaDisChaGra_SF, Offset: 17, Type: typelabel.Sunssf, Access: "r", Length: 1, Mandatory: true},
					smdx.PointElement{Id: VAChaMax_SF, Offset: 18, Type: typelabel.Sunssf, Access: "r", Length: 1},
					smdx.PointElement{Id: MinRsvPct_SF, Offset: 19, Type: typelabel.Sunssf, Access: "r", Length: 1},
					smdx.PointElement{Id: ChaState_SF, Offset: 20, Type: typelabel.Sunssf, Access: "r", Length: 1},
					smdx.PointElement{Id: StorAval_SF, Offset: 21, Type: typelabel.Sunssf, Access: "r", Length: 1},
					smdx.PointElement{Id: InBatV_SF, Offset: 22, Type: typelabel.Sunssf, Access: "r", Length: 1},
					smdx.PointElement{Id: InOutWRte_SF, Offset: 23, Type: typelabel.Sunssf, Access: "r", Length: 1},
				},
			},
		}})
}
