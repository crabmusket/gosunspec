...
type Block128 struct {
	ArGraMod   core.Enum16      `sunspec:"offset=0,len=1,access=rw"`
	...
	ModEna     core.Bitfield16  `sunspec:"offset=3,len=1,access=rw"`
	...
	ArGra_SF   core.ScaleFactor `sunspec:"offset=11,len=1,access=r"`
	VRefPct_SF core.ScaleFactor `sunspec:"offset=12,len=1,access=r"`
	Pad        core.Pad         `sunspec:"offset=13,len=1,access=r"`
}

func (self *Block128) GetId() core.ModelId {
	return ModelID
}
