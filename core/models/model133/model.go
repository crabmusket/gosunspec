...
type Block133Repeat struct {
	...
	IntvTyp core.Enum16      `sunspec:"offset=4,len=1,access=rw"`
	XTyp    core.Enum16      `sunspec:"offset=5,len=1,access=rw"`
	X_SF    core.ScaleFactor `sunspec:"offset=6,len=1,access=rw"`
	YTyp    core.Enum16      `sunspec:"offset=7,len=1,access=rw"`
	Y_SF    core.ScaleFactor `sunspec:"offset=8,len=1,access=rw"`
...
type Block133 struct {
	ActSchd core.Bitfield32 `sunspec:"offset=0,len=2,access=rw"`
	ModEna  core.Bitfield16 `sunspec:"offset=2,len=1,access=rw"`
	NSchd   uint16          `sunspec:"offset=3,len=1,access=r"`
	NPts    uint16          `sunspec:"offset=4,len=1,access=r"`
	Pad     core.Pad        `sunspec:"offset=5,len=1,access=r"`

	Repeats []Block133Repeat
}

func (self *Block133) GetId() core.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			...
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: X_SF, Offset: 6, Type: typelabel.Sunssf, Access: "rw", Length: 1, Mandatory: true},
					smdx.PointElement{Id: YTyp, Offset: 7, Type: typelabel.Enum16, Access: "rw", Length: 1, Mandatory: true},
					smdx.PointElement{Id: Y_SF, Offset: 8, Type: typelabel.Sunssf, Access: "rw", Length: 1, Mandatory: true},
