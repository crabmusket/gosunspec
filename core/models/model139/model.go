...
type Block139 struct {
	...
	Tms_SF  core.ScaleFactor `sunspec:"offset=7,len=1,access=r"`
	V_SF    core.ScaleFactor `sunspec:"offset=8,len=1,access=r"`
	CrvType core.Enum16      `sunspec:"offset=9,len=1,access=r"`

	Repeats []Block139Repeat
}

func (self *Block139) GetId() core.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: V_SF, Offset: 8, Type: typelabel.Sunssf, Access: "r", Length: 1, Mandatory: true},
