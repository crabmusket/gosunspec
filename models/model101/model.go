...
func (self *Block101) GetId() sunspec.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: AphB, Offset: 2, Type: typelabel.Uint16, ScaleFactor: "A_SF", Units: "A", Label: "Amps PhaseB", Description: "Phase B Current"},
					...
					smdx.PointElement{Id: PhVphB, Offset: 9, Type: typelabel.Uint16, ScaleFactor: "V_SF", Units: "V", Label: "Phase Voltage BN", Description: "Phase Voltage BN"},
