...
type Block120 struct {
	DERTyp          core.Enum16      `sunspec:"offset=0,len=1,access=r"`
	WRtg            uint16           `sunspec:"offset=1,len=1,sf=WRtg_SF,access=r"`
	WRtg_SF         core.ScaleFactor `sunspec:"offset=2,len=1,access=r"`
	VARtg           uint16           `sunspec:"offset=3,len=1,sf=VARtg_SF,access=r"`
	VARtg_SF        core.ScaleFactor `sunspec:"offset=4,len=1,access=r"`
	...
	VArRtg_SF       core.ScaleFactor `sunspec:"offset=9,len=1,access=r"`
	ARtg            uint16           `sunspec:"offset=10,len=1,sf=ARtg_SF,access=r"`
	ARtg_SF         core.ScaleFactor `sunspec:"offset=11,len=1,access=r"`
	...
	PFRtg_SF        core.ScaleFactor `sunspec:"offset=16,len=1,access=r"`
	WHRtg           uint16           `sunspec:"offset=17,len=1,sf=WHRtg_SF,access=r"`
	WHRtg_SF        core.ScaleFactor `sunspec:"offset=18,len=1,access=r"`
	AhrRtg          uint16           `sunspec:"offset=19,len=1,sf=AhrRtg_SF,access=r"`
	AhrRtg_SF       core.ScaleFactor `sunspec:"offset=20,len=1,access=r"`
	MaxChaRte       uint16           `sunspec:"offset=21,len=1,sf=MaxChaRte_SF,access=r"`
	MaxChaRte_SF    core.ScaleFactor `sunspec:"offset=22,len=1,access=r"`
	MaxDisChaRte    uint16           `sunspec:"offset=23,len=1,sf=MaxDisChaRte_SF,access=r"`
	MaxDisChaRte_SF core.ScaleFactor `sunspec:"offset=24,len=1,access=r"`
	Pad             core.Pad         `sunspec:"offset=25,len=1,access=r"`
}

func (self *Block120) GetId() core.ModelId {
	return ModelID
}
