...
func (self *Block211) GetId() core.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: PPV, Offset: 16, Type: typelabel.Float32, Units: "V"},
					smdx.PointElement{Id: PPVphAB, Offset: 18, Type: typelabel.Float32, Units: "V"},
