...
func (self *Block213) GetId() sunspec.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: PhV, Offset: 8, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Voltage LN", Description: "Line to Neutral AC Voltage (average of active phases)"},
					smdx.PointElement{Id: PhVphA, Offset: 10, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Phase Voltage AN", Description: "Phase Voltage AN"},
					smdx.PointElement{Id: PhVphB, Offset: 12, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Phase Voltage BN", Description: "Phase Voltage BN"},
					smdx.PointElement{Id: PhVphC, Offset: 14, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Phase Voltage CN", Description: "Phase Voltage CN"},
					smdx.PointElement{Id: PPV, Offset: 16, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Voltage LL", Description: "Line to Line AC Voltage (average of active phases)"},
					smdx.PointElement{Id: PPVphAB, Offset: 18, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Phase Voltage AB", Description: "Phase Voltage AB"},
					smdx.PointElement{Id: PPVphBC, Offset: 20, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Phase Voltage BC", Description: "Phase Voltage BC"},
					smdx.PointElement{Id: PPVphCA, Offset: 22, Type: typelabel.Float32, Units: "V", Mandatory: true, Label: "Phase Voltage CA", Description: "Phase Voltage CA"},
					...
					smdx.PointElement{Id: TotVArhImpQ1phA, Offset: 92, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Imported Q1 phase A", Description: ""},
					smdx.PointElement{Id: TotVArhImpQ1phB, Offset: 94, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Imported Q1 phase B", Description: ""},
					smdx.PointElement{Id: TotVArhImpQ1phC, Offset: 96, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Imported Q1 phase C", Description: ""},
					...
					smdx.PointElement{Id: TotVArhImpQ2phA, Offset: 100, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Imported Q2 phase A", Description: ""},
					smdx.PointElement{Id: TotVArhImpQ2phB, Offset: 102, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Imported Q2 phase B", Description: ""},
					smdx.PointElement{Id: TotVArhImpQ2phC, Offset: 104, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Imported Q2 phase C", Description: ""},
					...
					smdx.PointElement{Id: TotVArhExpQ3phA, Offset: 108, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Exported Q3 phase A", Description: ""},
					smdx.PointElement{Id: TotVArhExpQ3phB, Offset: 110, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Exported Q3 phase B", Description: ""},
					smdx.PointElement{Id: TotVArhExpQ3phC, Offset: 112, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Exported Q3 phase C", Description: ""},
					...
					smdx.PointElement{Id: TotVArhExpQ4phA, Offset: 116, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Exported Q4 Imported phase A", Description: ""},
					smdx.PointElement{Id: TotVArhExpQ4phB, Offset: 118, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Exported Q4 Imported phase B", Description: ""},
					smdx.PointElement{Id: TotVArhExpQ4phC, Offset: 120, Type: typelabel.Float32, Units: "varh", Label: "Total VAr-hours Exported Q4 Imported phase C", Description: ""},
