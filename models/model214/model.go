...
func (self *Block214) GetId() core.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: PhV, Offset: 8, Type: typelabel.Float32, Units: "V"},
					smdx.PointElement{Id: PhVphA, Offset: 10, Type: typelabel.Float32, Units: "V"},
					smdx.PointElement{Id: PhVphB, Offset: 12, Type: typelabel.Float32, Units: "V"},
