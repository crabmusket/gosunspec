		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: Off, Offset: 1, Type: typelabel.Uint16, Access: "rw", Mandatory: true, Label: "Offset", Description: "Starting offset for write operation"},
					...
					smdx.PointElement{Id: Ts, Offset: 82, Type: typelabel.Uint32, Access: "rw", Mandatory: true, Label: "Timestamp", Description: "Timestamp value is the number of seconds since January 1, 2000"},
					smdx.PointElement{Id: Ms, Offset: 84, Type: typelabel.Uint16, Access: "rw", Mandatory: true, Label: "Milliseconds", Description: "Millisecond counter 0-999"},
					smdx.PointElement{Id: Seq, Offset: 85, Type: typelabel.Uint16, Access: "rw", Mandatory: true, Label: "Sequence", Description: "Sequence number of request"},
					smdx.PointElement{Id: Role, Offset: 86, Type: typelabel.Uint16, Access: "rw", Mandatory: true, Label: "Role", Description: "Signing key used 0-5"},
					smdx.PointElement{Id: Rsrvd, Offset: 87, Type: typelabel.Pad, Access: "rw", Mandatory: true},
					smdx.PointElement{Id: Alg, Offset: 88, Type: typelabel.Enum16, Access: "rw", Mandatory: true, Label: "Algorithm", Description: "Algorithm used to compute the digital signature"},
					smdx.PointElement{Id: N, Offset: 89, Type: typelabel.Uint16, Access: "rw", Mandatory: true, Label: "N", Description: "Number of registers comprising the digital signature."},
				},
			},
			smdx.BlockElement{
				Length: 1,
