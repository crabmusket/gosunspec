		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					smdx.PointElement{Id: MajorFWRev, Offset: 0, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: MidFWRev, Offset: 1, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: MinorFWRev, Offset: 2, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: EncrypKey, Offset: 3, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: MAC_Address, Offset: 4, Type: typelabel.String, Length: 7, Mandatory: true},
					smdx.PointElement{Id: WritePassword, Offset: 11, Type: typelabel.String, Length: 8, Mandatory: true},
					smdx.PointElement{Id: EnableDHCP, Offset: 19, Type: typelabel.Enum16, Mandatory: true},
					smdx.PointElement{Id: TCPIP_address, Offset: 20, Type: typelabel.Ipaddr, Mandatory: true},
					smdx.PointElement{Id: Gateway_address, Offset: 22, Type: typelabel.Ipaddr, Mandatory: true},
					smdx.PointElement{Id: TCPIP_Netmask, Offset: 24, Type: typelabel.Ipaddr, Mandatory: true},
					smdx.PointElement{Id: DNS1_address, Offset: 26, Type: typelabel.Ipaddr, Mandatory: true},
					smdx.PointElement{Id: DNS2_address, Offset: 28, Type: typelabel.Ipaddr, Mandatory: true},
					smdx.PointElement{Id: Modbus_port, Offset: 30, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: SMTP_server_nm, Offset: 31, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: SMTP_account_nm, Offset: 51, Type: typelabel.String, Length: 16, Mandatory: true},
					smdx.PointElement{Id: SMTP_enable_SSL, Offset: 67, Type: typelabel.Enum16, Mandatory: true},
					smdx.PointElement{Id: SMTP_password, Offset: 68, Type: typelabel.String, Length: 8, Mandatory: true},
					smdx.PointElement{Id: SMTP_user_nm, Offset: 76, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: Stat_email_int, Offset: 96, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: Stat_start_HR, Offset: 97, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: Stat_email_sub, Offset: 98, Type: typelabel.String, Length: 25, Mandatory: true},
					smdx.PointElement{Id: Stat_email_addr1, Offset: 123, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: Stat_email_addr2, Offset: 143, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: Alarm_email_en, Offset: 163, Type: typelabel.Enum16, Mandatory: true},
					smdx.PointElement{Id: Alarm_email_sub, Offset: 164, Type: typelabel.String, Length: 25, Mandatory: true},
					smdx.PointElement{Id: Alarm_email_addr1, Offset: 189, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: Alarm_email_addr2, Offset: 209, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: FTP_password, Offset: 229, Type: typelabel.String, Length: 8, Mandatory: true},
					smdx.PointElement{Id: TELNET_password, Offset: 237, Type: typelabel.String, Length: 8, Mandatory: true},
					smdx.PointElement{Id: Log_write_int, Offset: 245, Type: typelabel.Uint16, Units: "Tms", Mandatory: true},
					smdx.PointElement{Id: Log_retain, Offset: 246, Type: typelabel.Uint16, Units: "Tmd", Mandatory: true},
					smdx.PointElement{Id: Log_mode, Offset: 247, Type: typelabel.Enum16, Mandatory: true},
					smdx.PointElement{Id: NTP_server_nm, Offset: 248, Type: typelabel.String, Length: 20, Mandatory: true},
					smdx.PointElement{Id: NTP_enable, Offset: 268, Type: typelabel.Enum16, Mandatory: true},
					smdx.PointElement{Id: TimeZone, Offset: 269, Type: typelabel.Int16, Units: "Tmh", Mandatory: true},
					smdx.PointElement{Id: Date_year, Offset: 270, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: Date_month, Offset: 271, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: Date_Day, Offset: 272, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: Time_hour, Offset: 273, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: Time_minute, Offset: 274, Type: typelabel.Uint16, Mandatory: true},
