		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: CC_Config_AUX_Nlite_On_hist, Offset: 41, Type: typelabel.Uint16, Units: "Tms", Mandatory: true, Label: "AUX Night Light On Hysterisis", Description: ""},
					smdx.PointElement{Id: CC_Config_AUX_Nlite_Off_hist, Offset: 42, Type: typelabel.Uint16, Units: "Tms", Mandatory: true, Label: "AUX Night Light Off Hysterisis", Description: ""},
					...
					smdx.PointElement{Id: CC_Config_AUX_Divert_Hyst_V, Offset: 47, Type: typelabel.Uint16, ScaleFactor: "V_SF", Units: "V", Mandatory: true, Label: "AUX Divert Hysterisis", Description: ""},
					...
					smdx.PointElement{Id: CC_Config_DataLog_Daily_AH, Offset: 53, Type: typelabel.Uint16, Units: "Ah", Mandatory: true, Label: "Data Log Daily", Description: ""},
					smdx.PointElement{Id: CC_Config_DataLog_Daily_KWH, Offset: 54, Type: typelabel.Uint16, ScaleFactor: "KWH_SF", Units: "kWh", Mandatory: true, Label: "Data Log Daily", Description: ""},
					smdx.PointElement{Id: CC_Config_DataLog_Max_Out_A, Offset: 55, Type: typelabel.Uint16, ScaleFactor: "V_SF", Units: "A", Mandatory: true, Label: "Data Log Daily Maximum Output", Description: ""},
					smdx.PointElement{Id: CC_Config_DataLog_Max_Out_W, Offset: 56, Type: typelabel.Uint16, ScaleFactor: "V_SF", Units: "W", Mandatory: true, Label: "Data Log Daily Maximum Output", Description: ""},
