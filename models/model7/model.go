...
type Block7 struct {
	...
	Sts   core.Enum16 `sunspec:"offset=1,access=r"`
	Ts    uint32      `sunspec:"offset=2,access=r"`
	Ms    uint16      `sunspec:"offset=4,access=r"`
	Seq   uint16      `sunspec:"offset=5,access=r"`
	Alm   core.Enum16 `sunspec:"offset=6"`
	Rsrvd core.Pad    `sunspec:"offset=7,access=r"`
	Alg   core.Enum16 `sunspec:"offset=8,access=r"`
	N     uint16      `sunspec:"offset=9,access=rw"`

	Repeats []Block7Repeat
}

func (self *Block7) GetId() core.ModelId {
	return ModelID
}
