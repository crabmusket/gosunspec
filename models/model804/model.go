		...
		Blocks: []smdx.BlockElement{
			smdx.BlockElement{
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: DoD, Offset: 7, Type: typelabel.Uint16, ScaleFactor: "DoD_SF", Units: "%"},
					smdx.PointElement{Id: NCyc, Offset: 8, Type: typelabel.Uint32},
					smdx.PointElement{Id: SoH, Offset: 10, Type: typelabel.Uint16, ScaleFactor: "SoH_SF", Units: "%"},
					smdx.PointElement{Id: A, Offset: 11, Type: typelabel.Int16, ScaleFactor: "A_SF", Units: "A", Mandatory: true},
					smdx.PointElement{Id: V, Offset: 12, Type: typelabel.Uint16, ScaleFactor: "V_SF", Units: "V"},
					smdx.PointElement{Id: CellVMax, Offset: 13, Type: typelabel.Uint16, ScaleFactor: "CellV_SF", Units: "V", Mandatory: true},
					smdx.PointElement{Id: CellVMaxMod, Offset: 14, Type: typelabel.Uint16},
					smdx.PointElement{Id: CellVMin, Offset: 15, Type: typelabel.Uint16, ScaleFactor: "CellV_SF", Units: "V", Mandatory: true},
					smdx.PointElement{Id: CellVMinMod, Offset: 16, Type: typelabel.Uint16},
					smdx.PointElement{Id: CellVAvg, Offset: 17, Type: typelabel.Uint16, ScaleFactor: "CellV_SF", Units: "V", Mandatory: true},
					smdx.PointElement{Id: ModTmpMax, Offset: 18, Type: typelabel.Int16, ScaleFactor: "ModTmp_SF", Units: "C", Mandatory: true},
					smdx.PointElement{Id: ModTmpMaxMod, Offset: 19, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: ModTmpMin, Offset: 20, Type: typelabel.Int16, ScaleFactor: "ModTmp_SF", Units: "C", Mandatory: true},
					smdx.PointElement{Id: ModTmpMinMod, Offset: 21, Type: typelabel.Uint16, Mandatory: true},
					smdx.PointElement{Id: ModTmpAvg, Offset: 22, Type: typelabel.Int16, ScaleFactor: "ModTmp_SF", Units: "C", Mandatory: true},
					smdx.PointElement{Id: Pad1, Offset: 23, Type: typelabel.Pad, Mandatory: true},
					smdx.PointElement{Id: ConSt, Offset: 24, Type: typelabel.Bitfield32},
					smdx.PointElement{Id: Evt1, Offset: 26, Type: typelabel.Bitfield32, Mandatory: true},
					smdx.PointElement{Id: Evt2, Offset: 28, Type: typelabel.Bitfield32},
					smdx.PointElement{Id: EvtVnd1, Offset: 30, Type: typelabel.Bitfield32},
					smdx.PointElement{Id: EvtVnd2, Offset: 32, Type: typelabel.Bitfield32},
					smdx.PointElement{Id: SetEna, Offset: 34, Type: typelabel.Enum16, Access: "rw"},
					smdx.PointElement{Id: SetCon, Offset: 35, Type: typelabel.Enum16, Access: "rw"},
					...
					smdx.PointElement{Id: Pad2, Offset: 43, Type: typelabel.Pad, Mandatory: true},
					smdx.PointElement{Id: Pad3, Offset: 44, Type: typelabel.Pad, Mandatory: true},
					smdx.PointElement{Id: Pad4, Offset: 45, Type: typelabel.Pad, Mandatory: true},
				},
			},
			smdx.BlockElement{Name: "lithium_ion_string_module",
				...
				Points: []smdx.PointElement{
					...
					smdx.PointElement{Id: ModCellVMinCell, Offset: 6, Type: typelabel.Uint16, ScaleFactor: "CellV_SF", Units: "V"},
					...
					smdx.PointElement{Id: Pad5, Offset: 13, Type: typelabel.Pad, Mandatory: true},
					smdx.PointElement{Id: Pad6, Offset: 14, Type: typelabel.Pad, Mandatory: true},
					smdx.PointElement{Id: Pad7, Offset: 15, Type: typelabel.Pad, Mandatory: true},
				},
			},
		}})
}
