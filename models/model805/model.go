...
type Block805Repeat struct {
	...
	CellSt  core.Bitfield32 `sunspec:"offset=2"`
}
...
type Block805 struct {
	...
	DoD_SF         core.ScaleFactor `sunspec:"offset=37"`
	V_SF           core.ScaleFactor `sunspec:"offset=38"`
	CellV_SF       core.ScaleFactor `sunspec:"offset=39"`
	Tmp_SF         core.ScaleFactor `sunspec:"offset=40"`
	Pad1           core.Pad         `sunspec:"offset=41"`

	Repeats []Block805Repeat
}

func (self *Block805) GetId() core.ModelId {
	return ModelID
}
